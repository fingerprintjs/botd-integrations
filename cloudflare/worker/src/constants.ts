...
export const PROCESSED_STR = "processed";
...
export const LIGHT_STATUS_HEADER = "botd-light-status";
export const LIGHT_PROB_HEADER = "botd-light-prob";
export const LIGHT_TYPE_HEADER = "botd-light-type";
